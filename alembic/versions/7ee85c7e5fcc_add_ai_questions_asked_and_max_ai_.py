...
def upgrade():
    ...
    op.add_column('lesson_creation_sessions', sa.Column('ai_questions_asked', sa.Integer(), nullable=True, comment='已提问的问题数量'))
    op.add_column('lesson_creation_sessions', sa.Column('max_ai_questions', sa.Integer(), nullable=True, comment='最大问题数量'))
